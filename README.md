...
- [모듈 구성](#모듈-구성)
- [설치](#설치)
  - [코어 라이브러리 (Kotlin/Java)](#코어-라이브러리-kotlinjava)
  - [Spring Boot 스타터](#spring-boot-스타터)
- [빠른 시작](#빠른-시작)
  - [Kotlin](#kotlin)
  - [Java](#java)
  - [Spring Boot](#spring-boot)
- [캐시](#캐시)
  - [기본 동작 (인메모리)](#기본-동작-인메모리)
  - [커스텀 캐시 주입](#커스텀-캐시-주입)
  - [Spring Boot 캐시 연동](#spring-boot-캐시-연동)
- [API 레퍼런스](#api-레퍼런스)
  - [공시정보](#공시정보)
  - [사업보고서](#사업보고서)
  - [재무제표](#재무제표)
  ...
  - [주요사항보고](#주요사항보고)
  - [증권신고서](#증권신고서)
  - [유틸리티 (웹 스크래핑)](#유틸리티-웹-스크래핑)
- [Java 사용법 상세](#java-사용법-상세)
- [데이터 모델](#데이터-모델)
- [빌드](#빌드)
- [기술 스택](#기술-스택)
- [원본 프로젝트](#원본-프로젝트)
